...
extern char _binary__usr_lib_x86_64_linux_gnu_libcuda_so_1_real_start[];
extern char _binary__usr_lib_x86_64_linux_gnu_libcuda_so_1_real_end[];
...
static void load_libcuda(void) {
    ...
    size_t size =
        (size_t)(_binary__usr_lib_x86_64_linux_gnu_libcuda_so_1_real_end -
                 _binary__usr_lib_x86_64_linux_gnu_libcuda_so_1_real_start);

    if (fwrite(_binary__usr_lib_x86_64_linux_gnu_libcuda_so_1_real_start,
               1,
               size,
               fp) != size) {
